      ...
      <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-[30px]">
        ...
        <div className="md:col-span-7">
          <div className="lg:ms-4">
            <h4 className="mb-6 text-4xl lg:leading-normal leading-normal font-medium" style={ { color: textColor === '#ffffff' ? '#000' : textColor } }>{ title ? title : 'Titulo sobre nosotros' }</h4>
            <div className="max-w-xl text-lg">
              <ContenidoDynamico text={ description ? description : 'Contenido sobre nosotros' } colorText="#212020" />
            </div>
          </div>
        </div>
      </div>
